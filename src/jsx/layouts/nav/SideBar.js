    ...
    >
      <PerfectScrollbar className="dlabnav-scroll">
		...
		<div className="copyright">
			<p className="text-center"><strong>Travl Hotel Admin Dashboard</strong> © 2022 All Rights Reserved</p>
			<p className="fs-12 text-center">Made with <span className="heart"></span> by DexignLab</p>
		</div>
      </PerfectScrollbar>
    </div>
  );
